...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm['website.Publication'].objects.all():
            if obj.attach:
                orm.PublicationAttach.objects.create(attach=obj.attach, publication=obj)

    def backwards(self, orm):
        "Write your backwards methods here."
        for obj in orm['website.PublicationAttach'].objects.all():
            obj.delete()
