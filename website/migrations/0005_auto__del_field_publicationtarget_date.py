...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PublicationTarget.date'
        db.delete_column('website_publicationtarget', 'date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PublicationTarget.date'
        raise RuntimeError("Cannot reverse this migration. 'PublicationTarget.date' and its values cannot be restored.")
