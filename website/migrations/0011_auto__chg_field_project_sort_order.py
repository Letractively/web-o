...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.sort_order'
        db.alter_column('website_project', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Project.sort_order'
        db.alter_column('website_project', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'website.project': {
            ...
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '500'}),
