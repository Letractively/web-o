...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicationAttach'
        db.create_table('website_publicationattach', (
            ...
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Publication'])),
        ))
        db.send_create_signal('website', ['PublicationAttach'])


    def backwards(self, orm):
        # Deleting model 'PublicationAttach'
        db.delete_table('website_publicationattach')
